                                ...
                                <tr key={user._id}>
                                    ...
                                    <td className="flex gap-3 justify-between">
                                        <button
                                            ...
                                            className="hover:shadow-lightBtn hover:shadow-md flex justify-center items-center bg-lightBtn text-white hover:bg-darkBtn md:px-2 md:py-1 btn-xs mr-1"
                                        >
                                            {user?.role === "admin"
                                                ? "Make User"
                                                : "Make Admin"}
                                        ...
                                        <button
                                            ...
                                            className="hover:shadow-red-700 hover:shadow-md flex justify-center items-center bg-red-600 md:px-2 md:py-1 hover:bg-red-700 text-white  btn-xs"
                                        >
                                            Delete
                                        </button>
                                    </td>
