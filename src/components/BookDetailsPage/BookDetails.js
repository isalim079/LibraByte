...
const BookDetails = () => {
    return (
        <div className='bg-lightWhite 2xl:h-[1200px] '>
            <div className='min-h-[100vh] 2xl:relative'>
                <div className='flex flex-col md:flex-row justify-center items-start px-5 xl:px-36 lg:px-24 md:px-14 2xl:px-44  py-2 2xl:py-20 '>
                    ...
                    <div className='w-full 2xl:w-1/2  mt-10 2xl:mt-16 mr-1 2xl:mr-16 ml-0 2xl:ml-6 pb-5 lg:pb-0'>
                        <h1 className='text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-bold 2xl:font-normal 2xl:text-7xl'>Inferno <span className='text-sm 2xl:text-2xl'>- The Ashtonishig Global</span></h1>
                        <h1 className='text-lg lg:text-xl 2xl:text-2xl font-semibold pt-2 2xl:pt-8 pb-5'>Dan Brown</h1>
                        <p className='text-justify'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Temporibus, distinctio perspiciatis asperiores a sit possimus rem necessitatibus. Modi minus quis nulla, iusto delectus architecto quod doloremque odit adipisci atque quam velit nihil rerum libero voluptates!</p>
                    </div>
                </div>
                <div className='bg-white mx-5 2xl:mx-44 min-h-72 2xl:absolute top-[450px] pb-5 2xl:pb-0'>
                    ...
                    <div className='p-10 2xl:p-24 flex flex-col md:flex-row justify-between items-center gap-x-20'>
