    ...
    return (
        <div className="">
            <div className="md:w-[300px] mx-auto space-y-8 shadow-[0px_0px_30px_2px_rgba(100,100,111,0.1)] mb-20 mt-10 relative p-8">
                ...
                <div>
                    <img
                        className="w-[60px] border h-[60px] object-cover rounded-full p-2 bg-[#12a197] duration-300 hover:scale-105"
                ...
                <div className="space-y-4">
                    ...
                    <ul className="space-y-3">
                        ...
                        <li className="flex items-center gap-2 text-sm text-sky-900 font-semibold">
                            ...
                            Borrow book atleast 15 per month{" "}
                        </li>
                    </ul>
