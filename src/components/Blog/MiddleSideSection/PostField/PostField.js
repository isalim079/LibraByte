    ...
    return (
        <div className="p-8 bg-lightWhite drop-shadow-lg rounded-md">
            <div>
                ...
                <input type="text" className=" w-full my-2 h-10 text-sm pl-4 focus:outline-none focus:border-2 focus:border-darkLightWhite" placeholder="Write your blog title" required name="postFieldTitle" id="" />
