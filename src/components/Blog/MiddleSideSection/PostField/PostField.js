    ...
    return (
        <div className="p-8 bg-lightWhite drop-shadow-lg rounded-md">
            <div>
                ...
                <textarea id="textArea" name="postField" cols="32" rows="6" className="border-2 border-t-0 border-l-1 border-r-0 border-b-oliveGreen/60 p-4 placeholder:text-sm focus:outline-none focus:border-2 focus:border-darkLightWhite" placeholder="Write your thoughts here..."></textarea>
