...
const Subscribe = () => {
    return (
        <div className="bg-royalBlue">
            <div className="text-white bg-bgTexture text-center px-4 md:px-20 lg:px-[140px] py-8 md:py-16 lg:py-12 h-screen lg:h-96 ">
            ...
            <Link href="/subscription">
                <button className="mt-6 lg:mt-0 btn btn-outline uppercase text-xl  font-semibold hover:font-extrabold border-none px-10 bg-lightBtn text-white hover:bg-darkBtn hover:shadow-customYellow hover:shadow-2xl hover:h-12 hover:text-white transition-all duration-500">Subscribe Now!</button>
            </Link>
        </div>
        </div>
    );
