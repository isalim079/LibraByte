    ...
    return (
        <div className="bg-royalBlue">
            ...
            <Link href="/subscription">
                <button className=" btn btn-outline uppercase text-xl font-semibold hover:font-extrabold border-none px-10 bg-teal-500 text-white hover:bg-teal-600 hover:shadow-customYellow hover:shadow-2xl hover:h-12 hover:text-white transition-all duration-500">Subscribe Now!</button>
            </Link>
        </div>
        </div>
    );
