        ...
        <div className="bg-lightWhite">
            <div className="max-w-screen-xl mx-auto pt-8">
                ...
                <div className=" grid grid-cols-12 lg:gap-6 md:gap-4 gap-2 mb-6">
                    <div className="col-span-3 bg-[#DBA084] lg:h-[280px] md:h-[210px] h-[140px]  lg:rounded-3xl md:rounded-2xl rounded-xl lg:p-10 md:p-6 p-0.5 ">
                        ...
                        <h1 className="font-medium text-md md:text-2xl lg:text-3xl  lg:pt-5 md:pt-3 pt-0 text-center">
                            Science Fiction
                        </h1>
                    </div>

                    <div className="col-span-4 bg-[#333D2E] lg:h-[280px] md:h-[210px] h-[140px]  lg:rounded-3xl md:rounded-2xl rounded-xl lg:p-10 md:p-6 p-0.5">
                    ...
                    <div className="col-span-5 bg-[#EFEDE1] lg:h-[280px] md:h-[210px] h-[140px]  lg:rounded-3xl md:rounded-2xl rounded-xl lg:p-10 md:p-6 p-0.5">
                ...
                <div className=" grid grid-cols-12 lg:gap-6 md:gap-4 gap-2">
                    ...
                    <div className="col-span-4 bg-[#DBA084]  lg:h-[280px] md:h-[210px] h-[140px]  lg:rounded-3xl md:rounded-2xl rounded-xl lg:p-10 md:p-6 p-0.5">
                        <div className="flex justify-center items-center px-5  md:p-2 md:pb-0.5 lg:pb-5">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="85"
                    ...
                    <div className="col-span-3  bg-[#333D2E] lg:h-[280px] md:h-[210px] h-[140px]  lg:rounded-3xl md:rounded-2xl rounded-xl lg:p-10 md:p-6 p-0.5 ">
                        <div className="flex justify-center items-center px-2.5  md:p-2 md:pb-0.5 lg:pb-5 ">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="85"
