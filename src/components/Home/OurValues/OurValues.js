    ...
    return (
        <div className="bg-bgTexture">
            ...
            <div className="my-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                <div className="">
                    <img src="https://i.ibb.co/mRQL6sF/brainstorming-1319789.png" alt="Shoes" className=" skeleton w-28 p-10 rounded-full mx-auto bg-[#F9DCA2]"/>
                ...
                <div className="">
                    <img src="https://i.ibb.co/SQMPy4g/shield-13624486.png" alt="Shoes" className=" skeleton w-28 p-10 rounded-full mx-auto bg-[#F9DCA2]" />
                    <div className="text-center">
                ...
                <div className="">
                    <img src="https://i.ibb.co/BCcjS0s/blended-learning-11832863.png" alt="Shoes" className=" skeleton w-28 p-10 rounded-full mx-auto bg-[#F9DCA2]" />
                    <div className="text-center">
                ...
                <div className="">
                    <img src="https://i.ibb.co/C9YPd58/team-3633449.png" alt="Shoes" className=" skeleton w-28 p-10 rounded-full mx-auto bg-[#F9DCA2]" />
                    <div className="text-center">
                ...
                <div className="">
                    <img src="https://i.ibb.co/gjP1yJL/learning-11152664.png" alt="Shoes" className=" skeleton w-28 p-10 rounded-full mx-auto bg-[#F9DCA2]" />
                    <div className="text-center">
                ...
                <div className="">
                    <img src="https://i.ibb.co/HK5vgGZ/efficiency-7973948.png" alt="Shoes" className=" skeleton w-28 p-10 rounded-full mx-auto bg-[#F9DCA2]" />
                    <div className="text-center">
